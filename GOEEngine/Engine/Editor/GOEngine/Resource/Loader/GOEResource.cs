...
namespace GOEngine.Implement
{
        ...
        class Resource
    {
        ...
        private Action<string, AssetBundle, bool> mBundleLoadCallback = null;
        ...
        public void AddGotBundleCallback(Action<string, AssetBundle, bool> callback)
        {
            mBundleLoadCallback -= callback;
            mBundleLoadCallback += callback;
        }

        public void ReleaseBundleCallback(Action<string, AssetBundle, bool> callback)
        {
        ...
        public void OnLoadRes()
        {
            ...
            if ( mBundleLoadCallback != null )
            {
                mBundleLoadCallback(mName, mResLoader.AssetBundle, DependencyResource);
